...
public class ScheduleActivity extends WQPToolsActivity {
    ...
    private String LOG = "ScheduleActivity";
    ...
    private void SetToolBar() {
        ...
        log_out_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Intent intent_login = new Intent(ScheduleActivity.this, LoginActivity.class);
