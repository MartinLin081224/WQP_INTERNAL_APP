...
public class VersionActivity extends WQPToolsActivity {
    ...
    private TextView detail_txt0;

    private Context mContext = this;

    private String LOG = "VersionActivity";
    ...
    private void SetToolBar() {
        ...
        log_out_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Intent intent_login = new Intent(VersionActivity.this, LoginActivity.class);
