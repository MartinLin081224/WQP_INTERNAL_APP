...
public class Picking_SignatureActivity extends WQPToolsActivity {
    ...
    private String LOG = "Picking_SignatureActivity";
            ...
            public void run() {
                ...
                try {
                    ...
                    RequestBody requestBody = new FormBody.Builder()
                            ...
                            .build();
                    Log.e(LOG, user_id_data);
                    Log.e(LOG, response_txt0);
                    Log.e(LOG, response_txt1);
                    Log.e(LOG, response_txt2);
                    Log.e(LOG, response_txt3);
                    Log.e(LOG, sign_name + ".png");
                    Request request = new Request.Builder()
                            .url("http://a.wqp-water.com.tw/WQP_OS/PickingSignatureLog.php")
                            .post(requestBody)
                            .build();
