...
public class EngMapsActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private String addressString;

    private String LOG = "EngMapsActivity";
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Geocoder geoCoder = new Geocoder(EngMapsActivity.this, Locale.getDefault());
        ...
        //mMap.addMarker(new MarkerOptions().position(sydney).title("客編"));
